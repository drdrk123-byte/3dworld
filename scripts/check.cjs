...
for(const f of ['public/app.js','public/ai-ui.js','api/generate.js','api/status.js','api/worlds.js','lib/worlds.cjs','lib/ai.cjs','server.cjs'])execFileSync(process.execPath,['--check',path.join(root,f)]);
